...
public class BossArtemisGoal extends MeleeAttackGoal {
    private final BossArtemisEntity entity;
    private int attackDelay = 10;
    private int ticksUntilNextAttack = 15;
    private boolean shouldCountTillNextAttack = false;

    public BossArtemisGoal(PathAwareEntity mob, double speed, boolean pauseWhenMobIdle) {
    ...
    protected void attack(LivingEntity pEnemy) {
        if (isEnemyWithinAttackDistance(pEnemy)) {
            ...
            entity.shootingAnimationTimeout = 0;
        }
    }
