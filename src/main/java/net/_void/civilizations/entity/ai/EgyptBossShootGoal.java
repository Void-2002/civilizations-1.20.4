        ...
        if (livingEntity != null) {
            ...
            if (livingEntity.squaredDistanceTo(this.entity) < (double)4096.0F && this.entity.canSee(livingEntity)) {
                ...
                if (this.cooldown == 20) {
                    ...
                    FireballEntity fireballEntity = new FireballEntity(world, this.entity, f * 4, g * 4, h * 4, 3);
                    fireballEntity.setPosition(this.entity.getX() + vec3d.x * (double)2.0F, this.entity.getBodyY((double)0.5F) + (double)0.5F, fireballEntity.getZ() + vec3d.z * (double)2.0F);
