...
public class BossAnubisEntity extends AnimalEntity {

    private static final TrackedData<Boolean> ATTACK = DataTracker.registerData(BossAnubisEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
    private static final TrackedData<Boolean> SPELL = DataTracker.registerData(BossAnubisEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
    ...
    protected void initGoals() {
        ...
        this.goalSelector.add(1, new BossAnubisSpellGoal(this));
        this.goalSelector.add(1, new BossAnubisAttackGoal(this, 1, true));
    ...
    public void setSpelling(boolean spelling){
        this.dataTracker.set(SPELL, spelling);
    }
