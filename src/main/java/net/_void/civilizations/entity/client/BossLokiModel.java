...
public class BossLokiModel <T extends BossLokiEntity> extends SinglePartEntityModel<T> {
    private final ModelPart body;
    private final ModelPart head;

    public BossLokiModel(ModelPart root) {
    ...
    @Override
    public void setAngles(BossLokiEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        this.getPart().traverse().forEach(ModelPart::resetTransform);
        this.setHeadAngles(netHeadYaw, headPitch);

        this.updateAnimation(entity.attackAnimationState, ModAnimations.LOKI_ATTACK, ageInTicks, 1f);
        this.updateAnimation(entity.potionAnimationState, ModAnimations.LOKI_POTION, ageInTicks, 1f);
        this.updateAnimation(entity.cloneAnimationState, ModAnimations.LOKI_CLONE, ageInTicks, 1f);
        this.updateAnimation(entity.summonAnimationState, ModAnimations.LOKI_SUMMON, ageInTicks, 1f);
    }
