...
public class ChinaCivilianModel<T extends ChinaCivilianEntity> extends SinglePartEntityModel<T> {
    ...
    public ChinaCivilianModel(ModelPart root) {
    ...
    @Override
    public void setAngles(ChinaCivilianEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
