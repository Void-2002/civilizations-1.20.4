...
public class GreeceCivilianModel <T extends GreeceCivilianEntity> extends SinglePartEntityModel<T> {
    private final ModelPart body;
    private final ModelPart head;

    public GreeceCivilianModel(ModelPart root) {
    ...
    @Override
    public void setAngles(GreeceCivilianEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
