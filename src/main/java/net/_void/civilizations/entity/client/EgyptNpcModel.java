...
public class EgyptNpcModel<T extends EgyptNpcEntity> extends SinglePartEntityModel<T> {
    private final ModelPart body;
    private final ModelPart head;

    public EgyptNpcModel(ModelPart root) {
    ...
    @Override
    public void setAngles(EgyptNpcEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
